        ...
        if i == 0: # if there are no words in the file, return zero
            ...
            for j in range(i-1, 0, -1): #Loop through the rest of the words in the file
                ...
                if lineLength <= columns: # if there is space left on the line 
                    ...
                    breadcrumbs[i] = j-1 #Each breadcrumb points to the cell to the left
    if value == True:
        text = ""
...
print(format(["Call", "me", "Ishmael."], 8, 3, True))

print(format(splitfile("C:/Users/tsaik/Desktop/CS Homework/CS140/huckleberry.txt"), 30, 2, True))
